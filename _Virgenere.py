from _files import table_virgenere, alfabet_of_virgenere

table = table_virgenere()

def virgenere_encrypt(text:str, key_word:str) -> str:
    '''
...
def virgenere_decrypt(text:str, key_word:str) -> str:
    '''
    Processo inverso ao da função 'virgenere_encrypt'.
    '''
    ...
    # Recebe ocabechalho da tabela de virgenere
    characters = alfabet_of_virgenere()
